...
class AgentState(TypedDict, total=False):
    ...
    # Additional fields used by nodes and routing logic.
    # - `evaluation_result`: gate for retry loop (True=success/acceptable)
    # - `pending_question`: clarification question text when asking user
    # - `proposed_action`: prepared risky action payload for approval
    # - `approval`: approval decision/result from HITL
